...
law run RunAllAnalysisTrainings --analysis-config sm-htt-analysis/$VERSION/sm.yaml --RunTraining-production-tag training_${VERSION}_1 --RunTesting-production-tag testing_${VERSION}_1
