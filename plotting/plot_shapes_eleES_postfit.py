...
def main(args):
    ...
    if args.single_category != "":
        ...
        catname = args.single_category.replace("htt_mt_", "").replace("htt_ee_", "")
    ...
    for category in categories:
        ...
        # w
        plot.add_hist(rootfile.get(era, channel, category, "W"), "W", "bkg")
        plot.setGraphStyle("W", "hist", fillcolor=styles.color_dict["W"])
        # ztt
        plot.add_hist(rootfile.get(era, channel, category, "ZTT"), "ZTT", "bkg")
        plot.setGraphStyle("ZTT", "hist", fillcolor=styles.color_dict["ZTT"])
        # emb
        plot.add_hist(rootfile.get(era, channel, category, "EMB"), "EMB", "bkg")
