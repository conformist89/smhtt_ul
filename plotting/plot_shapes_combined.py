...
def parse_arguments():
    ...
    parser.add_argument(
        "-c", "--channels", nargs="+", type=str, required=True, help="Channels"
    )
    ...
    parser.add_argument(
        "--exact-signals",
        action="store_true",
        help="if set, the stxs_stage1 signal is used for the plot instead of the inclusive signal",
    )
    parser.add_argument(
        "--combine-backgrounds",
        action="store_true",
...
signal_labels = {
    "inclusive": {
        "style": "inclusive",
        "label": "ggH + qqH",  # (#mu=0.75)",
        "label_prefit": "ggH + qqH",
    },
    "ggH": {"style": "ggH", "label": "ggH", "label_prefit": "ggH "},  # (#mu=0.68)",
    "ggH_hww": {"style": "ggH", "label": "ggH"},
    "qqH": {"style": "qqH", "label": "qqH", "label_prefit": "qqH"},  # (#mu=0.81)",
    "qqH_hww": {"style": "qqH", "label": "qqH"},
    "VH": {"style": "VH", "label": "qq#rightarrowVH"},
    "ttH": {"style": "ttH", "label": "ttH"},
    "HWW": {"style": "HWW", "label": "H#rightarrowWW"},
}
        ...
        category_labels.update(
            {
                ...
                "103": "ggH #geq 2 jet",
                "104": "ggH p_{T}^{H} > 200",
                "200": "qqH 2J low m_{jj}",
                "201": "qqH p_{T}^{H}>200",
                "202": "qqH vbftopo m_{jj}>700",
                "203": "qqH vbftopo m_{jj} [350,700]",
            }
        )
        ...
        category_labels.update(
            {
                ...
                "202": "qqH vbftopo_high m_{jj}",
                "203": "qqH vbftopo low m_{jj}",
            }
        )
    elif tag == "stxs_stage1p1_15node":
        category_labels.update(
            {
                "100": "#scale[0.92]{l: ggH 0 jet, p_{T}^{H} [0,10] GeV}",
                "101": "#scale[0.92]{l: ggH 0 jet, p_{T}^{H} [10,200] GeV}",
                "102": "#scale[0.92]{l: ggH 1 jet, p_{T}^{H} [0,60] GeV}",
                "103": "#scale[0.92]{l: ggH 1 jet, p_{T}^{H} [60,120] GeV}",
                "104": "#scale[0.92]{l: ggH 1 jet, p_{T}^{H} [120,200] GeV}",
                "105": "#scale[0.92]{l: ggH #geq 2 jet, m_{jj} [0,350] GeV, p_{T}^{H} [0,60] GeV}",
                "106": "#scale[0.92]{l: ggH #geq 2 jet, m_{jj} [0,350] GeV, p_{T}^{H} [60,120] GeV}",
                "107": "#scale[0.92]{l: ggH #geq 2 jet, m_{jj} [0,350] GeV, p_{T}^{H} [120,200] GeV}",
                "108": "#scale[0.92]{l: ggH p_{T}^{H} [200,300] GeV}",
                "109": "#scale[0.92]{l: ggH p_{T}^{H} > 300 GeV}",
                "110": "#scale[0.92]{l: ggH #geq 2 jet, m_{jj} > 350 GeV, p_{T}^{H} [0,200] GeV}",
                "111": "#scale[0.92]{l: ggH #geq 2 jet, m_{jj} [0,350] GeV, p_{T}^{H} [0,200] GeV}",
                "200": "#scale[0.92]{l: qqH 2 jet low m_{jj}}",
                "201": "#scale[0.92]{l: qqH p_{T}^{H} > 200 GeV}",
                "202": "#scale[0.92]{l: qqH #geq 2 jet, m_{jj} [700,#infty] GeV, p_{T}^{H} [0,200] GeV}",
                "203": "#scale[0.92]{l: qqH #geq 2 jet, m_{jj} [350,700] GeV, p_{T}^{H} [0,200] GeV}",
            }
        )
    elif tag == "stxs_stage0":
        category_labels.update({"1": "Signal categories"})
...
class plot:
    ...
    def print_plot_settings(self):
        logger.info(
            " ---- {} - {} - {} -----".format(self.era, self.channel, self.category)
        )
        logger.info(" ---- signals -----")
    ...
    def add_signal_hist(self, process, index):
        ...
        if self.era == "all" and self.channel == "cmb":
                    ...
                    for j, era in enumerate(["2016", "2017", "2018"]):
                        for k, channel in enumerate(["et", "mt", "tt", "em"]):
                            for h, category in enumerate(["105", "106", "107"]):
                                histid = "{}-{}-{}-{}".format(
                                    era, channel, category, subprocess
                                )
                                hists[histid] = {
                                    "era": era,
                                    "channel": channel,
            ...
            if self.category == "111":
                for i, subprocess in enumerate(
                    ...
                    for j, era in enumerate(["2016", "2017", "2018"]):
                        for h, category in enumerate(["105", "106", "107"]):
                            histid = "{}-{}-{}-{}".format(
                                era, self.channel, category, subprocess
                            )
                            hists[histid] = {
                                "era": era,
                ...
                for i, subprocess in enumerate(
                    ...
                    for j, era in enumerate(["2016", "2017", "2018"]):
                        ...
                        if self.channel == "et" and self.category in ["19"]:
                            continue
                        histid = "{}-{}-{}-{}".format(
                            era, self.channel, self.category, subprocess
                        )
                        hists[histid] = {
                            "era": era,
                            "channel": self.channel,
            ...
            if self.category == "111":
                for i, subprocess in enumerate(
                    ...
                    for k, channel in enumerate(["et", "mt", "tt", "em"]):
                        for h, category in enumerate(["105", "106", "107"]):
                            histid = "{}-{}-{}-{}".format(
                                self.era, channel, category, subprocess
                            )
                            hists[histid] = {
                                "era": self.era,
                                "channel": channel,
                ...
                for i, subprocess in enumerate(
                    ...
                    for k, channel in enumerate(["et", "mt", "tt", "em"]):
                        histid = "{}-{}-{}-{}".format(
                            self.era, channel, self.category, subprocess
                        )
                        hists[histid] = {
                            "era": self.era,
                            "channel": channel,
            ...
            for i, subprocess in enumerate(self.signal_processes[process]["histnames"]):
                histid = "{}-{}-{}-{}".format(
                    self.era, self.channel, self.category, subprocess
                )
                hists[histid] = {
                    "era": self.era,
                    "channel": self.channel,
        ...
        for histid in hists:
            hists[histid]["rootfile"] = self.rootfile.get(
                hists[histid]["era"],
                hists[histid]["channel"],
                hists[histid]["category"],
                hists[histid]["process"],
            )
            if not isinstance(hists[histid]["rootfile"], ROOT.TH1):
                hists.rm(histid)
        # if no files found nothing to do here
        if len(list(hists.keys())) == 0:
            logger.warning("No histograms for {} found --> skipping".format(process))
        else:
            # rebin
            best_binning = set(
                [
                    hists[min(hists.keys())]["rootfile"].GetBinLowEdge(i)
                    for i in range(hists[min(hists.keys())]["rootfile"].GetNbinsX() + 2)
                ]
            )
            ...
            for histid in hists:
                test_binning = set(
                    [
                        ...
                        for i in range(hists[histid]["rootfile"].GetNbinsX() + 2)
                    ]
                )
                best_binning = test_binning.intersection(best_binning)
                logger.debug("Initial binning: {}".format(best_binning))
            binning = np.array(sorted([x for x in list(best_binning) if x >= 0]))
            if self.category == 1:
            ...
            for histid in hists:
                hists[histid]["rootfile"] = hists[histid]["rootfile"].Rebin(
                    len(binning) - 1,
                    "{}_rebinned".format(hists[histid]["rootfile"].GetName()),
                    binning,
                )
                logger.debug("Rebinned: {}".format(hists[histid]["rootfile"]))
                logger.warning("found {} histograms".format(len(list(hists.keys()))))
            ...
            self.painter.subplot(index).add_hist(basehist, "{}".format(process))
            if process == "inclusive" and self.category == "1":
                ...
                self.painter.subplot(index).add_hist(
                    basehist, "{}_ratio".format(process)
                )
                self.painter.subplot(index).setGraphStyle(
    ...
    def add_background_hist(self, process, index):
        ...
        if self.era == "all" and self.channel == "cmb":
            ...
            if self.category == "111":
                for i, subprocess in enumerate(
                    ...
                    for j, channel in enumerate(["et", "mt", "tt", "em"]):
                        for h, category in enumerate(["105", "106", "107"]):
                            histid = "{}-{}-{}-{}".format(
                                self.era, channel, category, subprocess
                            )
        ...
        for histid in hists:
            logger.debug(
                "Trying to get {}: (era - {} / channel - {} / category - {} / process - {})".format(
                    histid,
                    hists[histid]["era"],
                    hists[histid]["channel"],
                    hists[histid]["category"],
            ...
            logger.debug(" --> Got histogram {}".format(histid))
            if not isinstance(hists[histid]["rootfile"], ROOT.TH1):
                hists.rm(histid)
        if len(list(hists.keys())) == 0:
            logger.warning("No histograms for {} found --> skipping".format(process))
    ...
    def add_data(self):
        ...
        if self.era == "all" and self.channel == "cmb":
            ...
            if self.category == "111":
                for k, channel in enumerate(["et", "mt", "tt", "em"]):
                    for h, category in enumerate(["105", "106", "107"]):
                        histid = "{}-{}-{}-{}".format(self.era, channel, category)
                        hists_data[histid] = {
                            "era": self.era,
                            "channel": channel,
                            "category": category,
                ...
                for k, channel in enumerate(["et", "mt", "tt", "em"]):
                    ...
                    if channel == "et" and self.category in ["19"]:
                        continue
                    histid = "{}-{}-{}".format(self.era, channel, self.category)
                    hists_data[histid] = {
                        "era": self.era,
                        "channel": channel,
                        "category": self.category,
        ...
        for histid in hists_data:
            hists_data[histid]["rootfile"] = self.rootfile.get(
                hists_data[histid]["era"],
                hists_data[histid]["channel"],
                hists_data[histid]["category"],
                "data_obs",
            )
            hists_bkg[histid]["rootfile"] = self.rootfile.get(
                hists_bkg[histid]["era"],
                hists_bkg[histid]["channel"],
                hists_bkg[histid]["category"],
                "TotalBkg",
            )
        # now the the smallest binning of all histograms
        best_binning = set(
            [
                hists_data[min(hists_data.keys())]["rootfile"].GetBinLowEdge(i)
                for i in range(
                    hists_data[min(hists_data.keys())]["rootfile"].GetNbinsX() + 2
                )
            ]
        )
        for histid in hists_data:
            test_binning = set(
                [
                    ...
                    for i in range(hists_data[histid]["rootfile"].GetNbinsX() + 2)
                ]
            )
            best_binning = test_binning.intersection(best_binning)
        binning = np.array(sorted([x for x in list(best_binning) if x >= 0]))
        ...
        for histid in hists_bkg:
            ...
            hists_bkg[histid]["rootfile"] = hists_bkg[histid]["rootfile"].Rebin(
                len(binning) - 1,
                "{}_rebinned".format(hists_bkg[histid]["rootfile"].GetName()),
                binning,
            )
    ...
    def blind_data(self, data_obs):
        if self.category == "1":
            ...
            for i in range(data_obs.GetNbinsX() + 1):
                if (
                    data_obs.GetBinLowEdge(i) in [4.0, 5.0, 6.0]
    ...
    def assemble_ratio(self):
        ...
        if self.isSignal and self.plotConfig.settings["exact_signals"]:
            ...
            for i, sublabel in enumerate(["main", "ggH_rest", "qqH_rest"]):
                signal = self.painter.subplot(1).get_hist("{}_signal".format(sublabel))
            ...
            for process in ["qqH", "ggH", "inclusive"]:
                ...
                signal.Add(self.painter.subplot(1).get_hist("total_bkg"))
                self.painter.subplot(1).add_hist(signal, "bkg_{}".format(process))
                self.painter.subplot(1).setGraphStyle(
                    "bkg_{}".format(process),
                    "hist",
    ...
    def set_axis_range(self):
        self.painter.subplot(0).setYlims(
            ...
            max(
                2.5 * self.painter.subplot(0).get_hist("data_obs").GetMaximum(),
                self.plotConfig.split_dict[self.channel] * 2.5,
            ),
        )
        ...
        if self.category == "1":
            self.painter.subplot(0).setYlims(
                self.plotConfig.split_dict[self.channel],
                max(
                    1.5 * self.painter.subplot(0).get_hist("data_obs").GetMaximum(),
            ...
            if self.era == "all" and self.channel == "cmb":
                ...
                self.painter.subplot(1).setYlims(0.85, 2.05)
        ...
        if self.plotConfig.tag == "stxs_stage1p1_15node":
            if self.era == "all" and self.channel == "cmb":
                ...
                if self.category == "110":
                    self.painter.subplot(1).setYlims(0.85, 1.55)
                if self.category == "111":
                    self.painter.subplot(1).setYlims(0.95, 1.1)
                ...
                if (
                    self.category == "200"
                    or self.category == "201"
                    or self.category == "202"
                    or self.category == "203"
                ):
                    self.painter.subplot(1).setYlims(0.65, 2.05)
                elif self.category == "110":
                    self.painter.subplot(1).setYlims(0.85, 1.55)
                else:
                    self.painter.subplot(1).setYlims(0.9, 1.22)  # 0.75, 1.55
                # self.painter.subplot(0).setYlims(1, 45000000000)
                self.painter.subplot(0).setYlims(0.1, 4500000000)
    ...
    def set_axis_labels(self):
        ...
        if self.plotConfig.tag == "stxs_stage0" and self.category == "1":
            ...
            self.painter.subplot(1).setXlabel("2D discriminant Bin Index")
            # self.painter.subplot(1).setNXdivisions(28, 0)
            # self.painter.subplot(1).changeXLabels(["Bin {}".format(x) for x in xrange(29)])
        else:
            self.painter.subplot(1).setXlabel("y_{l}")  # "max(y_{i})")  #"NN score")
        if self.plotConfig.settings["normalize_by_bin_width"]:
            if self.plotConfig.tag == "stxs_stage0" and self.category == "1":
                self.painter.subplot(0).setYlabel("dN/d(2D d.b.i.)  ")
            else:
                self.painter.subplot(0).setYlabel(
                    "dN/d(max(y_{i}))"
                )  # y_{%s})  "%get_label_for_category(self.category, self.plotConfig.tag))   #NN score)  ")
        else:
    ...
    def rescale_upper_plot(self):
        ...
        for interval in scaling:
            content = []
            for i in range(
                self.painter.subplot(0).get_hist("data_obs").GetNbinsX() + 1
            ):
                binedge = self.painter.subplot(0).get_hist("data_obs").GetBinLowEdge(i)
                if (
                    binedge >= scaling[interval]["interval"][0]
                    and binedge < scaling[interval]["interval"][1]
                ):
                    content.append(
                        self.painter.subplot(0).get_hist("data_obs").GetBinContent(i)
                    )
        ...
        for hist_name in list(self.painter.subplot(0)._hists.keys()):
            histogram = self.painter.subplot(0).get_hist(hist_name)
            for i in range(histogram.GetNbinsX() + 1):
    ...
    def draw_subplots(self, plot):
        procs_to_draw_0 = ["stack", "total_bkg", "data_obs"]

        if self.isSignal:
            procs_to_draw_0 += list(self.signal_processes.keys())
            if self.category == "1":
                procs_to_draw_0.remove("inclusive")
        if self.category == "1":
            self.painter.subplot(0).get_hist("total_bkg").Add(
                self.painter.subplot(0).get_hist("inclusive")
            )
    ...
    def set_upper_legend(self):
        ...
        for signal in self.signal_processes:
            if self.category == "1" and signal == "inclusive":
                self.painter.legend(0).add_entry(
                    0, signal, self.signal_processes[signal]["label"], "f"
                )
            else:
                try:
                    self.painter.legend(0).add_entry(
                        0, signal, self.signal_processes[signal]["label"], "l"
                    )
                except BaseException:
                    pass
        ...
        if args.chi2test:
            ...
            self.painter.DrawText(0.7, 0.3, "\chi^{2}/ndf = " + str(round(chi2, 3)))
    ...
    def set_ratio_legend(self):
        if self.isSignal:
            ...
            ncol = 3
            width = 0.75 * 0.8
        self.painter.add_legend(reference_subplot=1, pos=1, width=width, height=height)
        self.painter.legend(1).setNColumns(ncol)
        self.painter.legend(1).add_entry(1, "data_obs", "Observed", "PEL")
        self.painter.legend(1).add_entry(1, "total_bkg", "Bkg. unc.", "f")
        if self.isSignal and self.plotConfig.settings["exact_signals"]:
            main_signal_label = ""
            if (
                len(get_signal_for_category(self.category)["displayname"].split(", "))
                > 2
            ):
                ...
                if "prefit" in self.plotConfig.inputfile:
                    main_signal_label = "#splitline{%s}{%s}" % (
                        ", ".join(
                            get_signal_for_category(self.category)["displayname"].split(
                                ", "
                            )[:2]
                        ),
                        get_signal_for_category(self.category)["displayname"].split(
                ...
                if "prefit" in self.plotConfig.inputfile:
                    ...
                    main_signal_label = get_signal_for_category(self.category)[
                        "displayname"
                    ]
                    # main_signal_label = "#splitline{%s}{(#mu=%s)}" % (
                    #    get_signal_for_category(
                    #        self.category)["displayname"], mu_dict[self.category])
            self.painter.legend(1).add_entry(1, "main_signal", main_signal_label, "l")
            self.painter.legend(1).add_entry(
                1,
                "ggH_rest_signal",
                "ggH {}".format(
                    " (others)"
                    if "ggH" in get_signal_for_category(self.category)["displayname"]
                    else ""
                ),
                "l",
            )
            self.painter.legend(1).add_entry(
                ...
                "qqH {}".format(
                    " (others)"
                    if "qqH" in get_signal_for_category(self.category)["displayname"]
                    else ""
                ),
                "l",
            )
            ...
            if "prefit" in self.plotConfig.inputfile:
                ...
                self.painter.legend(1).add_entry(
                    1,
                    "inclusive_ratio",
                    "{}".format(signal_labels["inclusive"]["label_prefit"]),
                    "l",
                )
            else:
                self.painter.legend(1).add_entry(
                ...
                self.painter.legend(1).add_entry(
                    1,
                    "inclusive_ratio",
                    "{}".format(signal_labels["inclusive"]["label"]),
                    "l",
                )
        self.painter.legend(1).setAlpha(0.0)
        self.painter.legend(1).scaleTextSize(1.2)
    ...
    def draw_lines(self):
        ...
        if self.category == "1":
            ...
            height = max(
                self.painter.subplot(0).get_hist("data_obs").GetMaximum(),
                self.plotConfig.split_dict[self.channel],
            )
            ...
            for i, edge in enumerate(signalsteps):
                ...
                self.painter.add_line(
                    1,
                    xmin=edge,
                    ymin=round(subplot_min, 3),
                    xmax=edge,
                    ymax=0.7 * round(subplot_max, 3),
                    color=16,
                    linestyle=7,
                    linewidth=2,
                )
        ...
        for i in range(len(self.painter._lines)):
        ...
        for channel in self.channels:
            for category in self.categories[channel]:
                single_plot = plot(
                    ...
                    self.era,
                    channel,
                    get_label_for_category(category, self.tag),
                    self,
                ...
                if not self.settings["embedding"] and not self.settings["fake_factor"]:
                    bkg_processes = [
                        "QCD",
                        "VVT",
                        "VVL",
                ...
                if self.settings["combine_backgrounds"]:
                    ...
                    single_plot.add_background(
                        ...
                        styles.color_dict["jetFakes"],
                        ["QCD", "jetFakes"],
                    )
                    single_plot.add_background(
                        "EMB",
                        styles.legend_label_dict["EMBCMB"],
                ...
                if category not in self.background_categories:
                    if not self.settings["combine_backgrounds"]:
                        ...
                        single_plot.add_signal(
                            "VH",
                            signal_labels["VH"]["label"],
                            styles.color_dict[signal_labels["VH"]["style"]],
                            ["VH_htt", "ZH_htt", "WH_htt"],
                            False,
                        )
                        single_plot.add_signal(
                            "HWW",
                            signal_labels["HWW"]["label"],
                            styles.color_dict[signal_labels["HWW"]["style"]],
                            ["qqH_hww", "ggH_hww"],
                            False,
                        )
                    if self.settings["exact_signals"]:
                        main_signals = get_signal_for_category(category)["signals"]
                        merge_signals_ggH = [
                            x
                            for x in self.detailed_signals
                        ...
                        if (
                            len(
                                get_signal_for_category(category)["displayname"].split(
                                    ", "
                                )
                            )
                            > 2
                            ...
                            if "prefit" in self.inputfile:
                                ...
                                main_signal_label = "#scale[0.6]{%s}" % (
                                    get_signal_for_category(category)["displayname"]
                                )
                                # main_signal_label = "#splitline{%s}{%s (#mu=%s)}" % (
                                #    ", ".join(
                                #        get_signal_for_category(category)
                            ...
                            if "prefit" in self.inputfile:
                                ...
                                main_signal_label = get_signal_for_category(category)[
                                    "displayname"
                                ]
                            # main_signal_label = "#splitline{%s}{(#mu=%s)}" % (
                            #    get_signal_for_category(category)
                            #    ["displayname"], mu_dict[category])
                        single_plot.mainsignal = get_signal_for_category(category)
                        single_plot.add_signal(
                            "main_signal",
                            main_signal_label,
                        ...
                        single_plot.add_signal(
                            ...
                            "ggH {}".format(
                                " (others)"
                                if "ggH"
                                in get_signal_for_category(category)["displayname"]
                                else ""
                            ),
                        ...
                        if "prefit" in self.inputfile:
                            ...
                            single_plot.add_signal(
                                "inclusive",
                                signal_labels["inclusive"]["label_prefit"],
                                styles.color_dict["inclusive"],
                                ["qqH_htt", "ggH_htt"],
                                True,
                            )
...
def main(args):
    ...
    plotConfig = plotConfigurator(args.categories, args.channels, args.era, args.input)
    for plot in plotConfig.plots:
        ...
        plot.painter.DrawChannelCategoryLabel(
            " {}".format(get_label_for_category(category, plotConfig.tag)),
            begin_left=None,
            textsize=0.031,
        )  # 0.026
        ...
        if plot.category == "1":
            for i, interval in enumerate(scaling):
                ...
                # step = 0.03042 * scaling[interval]["interval"][0] + 0.1211
                step = (
                    0.03042 * 72 / 75 * scaling[interval]["interval"][0] + 0.1211 * 1.2
                )
                plot.painter.DrawText(
                    step,
                    0.72,
                    "x {}".format(int(scaling[interval]["sf"])),
                    textsize=0.025,
        ...
        postfix = (
            "prefit"
            if "prefit" in plotConfig.inputfile
            else "postfit"
            if "postfit" in plotConfig.inputfile
            else "undefined"
        )
        plot.painter.save(
            "%s/%s_%s_%s_%s.%s"
