...
common_files_2016 = {
    ...
    "ggH_95": [
        "GluGluHToTauTauM95_RunIISummer16MiniAODv3_Private_13TeV_USER_powheg-pythia8_v1",
    ],
    "qqH_95": [
        "VBFHToTauTauM95_RunIISummer16MiniAODv3_Private_13TeV_USER_powheg-pythia8_v1",
    ],
    **{
        "susybbH_{}".format(mass): [
            "SUSYGluGluToBBHToTauTauM{}_RunIISummer16MiniAODv3_94X_13TeV_MINIAOD_amcatnlo-pythia8_v2".format(
                mass
            )
        ]
        for mass in [
    ...
    **{
        "susybbH_{}".format(mass): [
            "SUSYGluGluToBBHToTauTauM{}_RunIISummer16MiniAODv3_94X_13TeV_MINIAOD_amcatnlo-pythia8_v3".format(
                mass
            )
        ]
    ...
    **{
        "susybbHpowheg_{}".format(mass): [
            "SUSYGluGluToBBHToTauTauM{}_RunIISummer16MiniAODv3_PUMoriond17_13TeV_MINIAOD_powheg-pythia8_v1".format(
                mass
            )
        ]
        for mass in [
    ...
    **{
        "susyggH_{}".format(mass): [
            "SUSYGluGluToHToTauTauM{}_RunIISummer16MiniAODv3_PUMoriond17_13TeV_MINIAOD_pythia8_v2".format(
                mass
            )
        ]
        for mass in [
    ...
    **{
        "susyggHpowheg_{}".format(mass): [
            "SUSYGluGluToHToTauTauM{}_RunIISummer16MiniAODv3_PUMoriond17_13TeV_MINIAOD_powheg-pythia8_v3".format(
                mass
            )
        ]
        for mass in [800]
    ...
    **{
        "susyggHpowheg_{}".format(mass): [
            "SUSYGluGluToHToTauTauM{}_RunIISummer16MiniAODv3_PUMoriond17_13TeV_MINIAOD_powheg-pythia8_v4".format(
                mass
            )
        ]
        for mass in [
    ...
    **{
        "susyggHpowheg_{}".format(mass): [
            "SUSYGluGluToHToTauTauM{}_RunIISummer16MiniAODv3_PUMoriond17_13TeV_MINIAOD_powheg-pythia8_v5".format(
                mass
            )
        ]
        for mass in [200]
    ...
    **{
        "susyggHpowheg_{}".format(mass): [
            "SUSYGluGluToHToTauTauM{}_RunIISummer16MiniAODv3_PUMoriond17_13TeV_MINIAOD_powheg-pythia8_v6".format(
                mass
            )
        ]
    ...
    **{
        "susyggHpowheg_{}".format(mass): [
            "SUSYGluGluToHToTauTauM{}_RunIISummer16MiniAODv3_PUMoriond17_13TeV_MINIAOD_powheg-pythia8_v7".format(
                mass
            )
        ]
        for mass in [130]
...
common_files_2017 = {
    ...
    "ggH_95": [
        "GluGluHToTauTauM95_RunIIFall17MiniAODv2_Private_13TeV_USER_powheg-pythia8_v1",
    ],
    "qqH_95": [
        "VBFHToTauTauM95_RunIIFall17MiniAODv2_PRIVATE_13TeV_USER_powheg-pythia8_v1",
    ],
    **{
        "susybbH_{}".format(mass): [
            "SUSYGluGluToBBHToTauTauM{}_RunIIFall17MiniAODv2_PU2017_13TeV_MINIAOD_amcatnlo-pythia8_v1".format(
                mass
            )
        ]
        for mass in [
    ...
    **{
        "susybbHpowheg_{}".format(mass): [
            "SUSYGluGluToBBHToTauTauM{}_RunIIFall17MiniAODv2_PU2017_13TeV_MINIAOD_powheg-pythia8_v2".format(
                mass
            )
        ]
        for mass in [
    ...
    **{
        "susyggH_{}".format(mass): [
            "SUSYGluGluToHToTauTauM{}_RunIIFall17MiniAODv2_PU2017_13TeV_MINIAOD_pythia8_v1".format(
                mass
            )
        ]
        for mass in [
    ...
    **{
        "susyggHpowheg_{}".format(mass): [
            "SUSYGluGluToHToTauTauM{}_RunIIFall17MiniAODv2_PU2017_13TeV_MINIAOD_powheg-pythia8_v3".format(
                mass
            )
        ]
        for mass in [1800, 2000]
    },
    **{
        "susyggHpowheg_{}".format(mass): [
            "SUSYGluGluToHToTauTauM{}_RunIIFall17MiniAODv2_PU2017_13TeV_MINIAOD_powheg-pythia8_v4".format(
                mass
            )
        ]
        for mass in [
