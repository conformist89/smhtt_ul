...
# categories=("Pt20to25" "Pt25to30" "Pt30to35" "Pt35to40" "PtGt40" )


tag_folder="muonID_uncorr"
...
for cat in ${categories[@]}; do
    ...
    # ls lscan/${tag_folder}/${ERA}/${CHANNEL}/${WP}/${cat}/${poi}/
    ...
    plot1DScan.py  higgsCombine.nominal_${poi}.MultiDimFit.mH125.root --POI $poi --y-max 6 --output ${TAG}_${ERA}_${CHANNEL}_${WP}_${cat}
    mv ${TAG}_${ERA}_${CHANNEL}_${WP}_${cat}*  lscan/${tag_folder}/${ERA}/${CHANNEL}/${WP}/${cat}/${poi}/
