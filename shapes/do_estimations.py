...
def qcd_estimation(
    ...
    if is_embedding:
        ...
        if "em" in channel:
            ...
            procs_to_subtract = ["EMB", "ZL", "ZTT", "TTL", "TTT", "VVL", "VVT"]
    else:
        procs_to_subtract = [
            "ZTT",
            "ZL",
        ...
        if "em" in channel:
            ...
            procs_to_subtract = ["ZL", "ZTT", "TTL", "TTT", "VVL", "VVT"]
    ...
    if base_hist.Integral() > 0.0:
        ...
        logger.warning(
            "No data in same-sign region for histogram %s. Setting extrapolation factor to 0.0 (integral is %.2f).",
            base_hist.GetName(),
            base_hist.Integral()
        )
        base_hist.Scale(0.0)
